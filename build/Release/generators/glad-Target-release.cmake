...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET glad::glad
                 ...
                 $<$<CONFIG:Release>:${glad_LINKER_FLAGS_RELEASE}> APPEND)
    set_property(TARGET glad::glad
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${glad_INCLUDE_DIRS_RELEASE}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET glad::glad
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${glad_LIB_DIRS_RELEASE}> APPEND)
    set_property(TARGET glad::glad
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${glad_COMPILE_DEFINITIONS_RELEASE}> APPEND)
    set_property(TARGET glad::glad
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${glad_COMPILE_OPTIONS_RELEASE}> APPEND)
